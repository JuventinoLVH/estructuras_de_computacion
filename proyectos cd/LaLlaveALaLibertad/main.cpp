/* Nombre: main.cpp
   ...
   Fecha: 6/05/21
   Descripción: Cliente para probara la clase ArbolB
*/
...
int main()
{
    cout<<"Buenos dias.A continuaci\242n se mostrara la genialidad de la clase ArbolB, para ello tendra "<<
