 ...
 *****************************************************************************************/
    ...
    *
    * \param eClave La etiqueta de la clave
    * \exception std::bad_alloc No hay memoria para el nodo
    *
    */void Agregar(const T & eClave);

    //*************************************************************************************
    /** \brief Elimina una clave del arbol
    *
    * \param eClave La etiqueta de la clave a eliminar
    * \return True Sí borro algo, false de lo contrario
    *
    */bool Eliminar(const T & eClave);

    //*************************************************************************************
    /** \brief Busca una clave en el arbol
    *
    * \param eClave La etiqueta de la clave a buscar
    * \return True Sí la clave se encuentra en el arbol, false de lo contrario
    *
    */bool Buscar(const T & eClave) const;
 ...
 *****************************************************************************************/
    ...
    *
    */void Partir(Nodo *&subRaiz, Nodo *hijo, unsigned i);
    ...
    * \exception std::bad_alloc No hay memoria para las operaciones
    *
    */void Mezclar(Nodo *&subRaiz, Nodo *hijo, unsigned i);
    ...
    * \exception std::bad_alloc No hay memoria para el nodo
    *
    */void Agregar(const T &eClave, Nodo *&subRaiz);
    ...
    * \exception std::bad_alloc No hay memoria para el nodo
    *
    */bool Eliminar(const T &eClave,  Nodo *&subRaiz);

    //*************************************************************************************
    /** \brief Busca una clave en unn subArbol
    *
    * \param eClave la etiqueta de la clave
    * \param subRaiz la raiz del subArbol
    * \return El valor del mayor de los menores
    *
    */bool Buscar(const T & eClave,Nodo *subRaiz) const;
