/* Nombre: main.cpp
   ...
   Fecha: 14/04/21
   Descripción: Cliente para probara la clase ArbolDeBB
*/
 ...
 *
 * \param abb El ArbolDeBB en la que se realizará la operación
 * \param op La operación a efectuar
 * \return si La operación se realizo exitosamente
 *
 */
template<typename T>
bool RealizarOp(ArbolDeBB<T> & abb, char op);
...
int main()
{
    cout<<"Buenos dias.A continuaci\242n se mostrara el arbitrio de la clase ArbolDeBB, para ello tendra "<<
            "a su dispoci\242n 3 tipos de arboles:\nuno de enteros, de caracteres y otro de vectores.\n";

    ArbolDeBB<int> abbI;
    ArbolDeBB<char> abbC;
    ArbolDeBB<Vector> abbV;
    bool exito;
    char tList,op;
