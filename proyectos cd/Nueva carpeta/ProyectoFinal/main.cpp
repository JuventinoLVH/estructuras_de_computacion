...
int main()
{
    ifstream input_file("entrada.txt");
    ...
    while (input_file >> number) {
        cout<<"N\242mero a meter: "<<number<<'\n';
        abI.Agregar(number);
        cout<<abI<<'\n';
        abI.Imprimir(ASCENDENTE);
        cout<<'\n';
         system("pause");
        system("cls");
    }
    ...
    try
    {
        switch(op)
        {
            ...
            case '4': //Número de nodos
                cout<<"El arbol tiene : "<<ab.NumeroDeElementos()<<" claves";
                break;
