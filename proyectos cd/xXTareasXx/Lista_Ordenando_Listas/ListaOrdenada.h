 ...
 *****************************************************************************************/
    //*************************************************************************************
    /** \brief Agrega un elemento y lo ordena
    *
    ...
    */void AgregarElemento(const T & val);
    ...
    //*************************************************************************************
    /** \brief Elimina el un elemento
    *
    * \param val El valor a agregar
    * \return true si el valor se borro exitosamente
    *
    ...
    *
    */void ImprimirAscendente(std::ostream & salida=std::cout) const ;
 ...
 *****************************************************************************************/
    ...
    //*************************************************************************************
    /** \brief Función que busca el lugar de un elemento en la cola
    *
    * \param val El valor a 'ordenar'
    * \return El indice a donde pertenece
    *
    */int PosDeValor(const T & val);
