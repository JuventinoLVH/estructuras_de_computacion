/* Nombre: ListaDobEnlazada.tpp
   Autor: Luis Juventino Velasquez H.
   Fecha: 20/03/21
   Descripción: Archivo de implementación de la clase ListaDobEnlazada
*/
...
//*************************************************************************************
template <typename T>
void ListaDobEnlazada<T>::Imprimir(std::ostream & salida/*=std::cout*/) const
{
    salida<<'{';
...
//*************************************************************************************
template <typename T>
void ListaDobEnlazada<T>::ImprimirDescendente(std::ostream & salida/*=std::cout*/) const
{
    salida<<'{';
