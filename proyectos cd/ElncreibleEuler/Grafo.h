...
//*************************************************************************************
    /** \brief Calcula el paseo de euler de la grafica
    *
    * \return una pila con un paseo de euler
    * \exception std:::exception::NoExistePaseoDeEuler La grafica no tiene paseo de euler
    * \exception std:::exception::GrafoVacio No hay grafica
    * \exception std::bad_aloc No hay memoria suficiente para realizar los calculos
    *
    */Pila<T> PaseoDeEuler()const;
 ...
 *****************************************************************************************/
    ...
    //*************************************************************************************
    class NoExistePaseoDeEuler: public std::exception
    {
        public:
            virtual const char * what() const throw();
        private:
